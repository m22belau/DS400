...
```{r}
plot_gamma(shape = 10.242, rate = 1.847, mean = TRUE, mode = TRUE)
```
...
1.  Why is the Poisson model a reasonable choice for our data Yi?
    ...
    -  This is count data so it fits the data type for the Poisson model 
    -  This generally fits our prior understnad of how many goals can be scored in a soccer game, usuallt 
